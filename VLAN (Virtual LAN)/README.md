...
Questa guida documenta la configurazione di container Docker su un Raspberry Pi utilizzando il driver di rete **IPVLAN** in modalità L2 su una **VLAN dedicata (802.1Q)**. Include la teoria necessaria per capire cosa si sta facendo e i problemi che ho incontrato nella pratica.
...
| Sezione | Contenuto |
|---|---|
| [Teoria VLAN](docs/teoria-vlan.md) | Perchè segmentare la rete, VLAN tagging (IEEE 802.1Q), porte Access vs Trunk |
...
| [Installazione](docs/installazione.md) | Guida passo-passo: interfaccia VLAN, rete Docker IPVLAN, test di connettività, tcpdump, deploy Pi-hole, migrazione da bridge |
