...
| Documento | Contenuto |
|---|---|
| [Cos'e' un SOC e i Tier](docs/tier-soc.md) | Definizione di SOC, ruoli L1/L2/L3 con responsabilita', skill richieste e applicazione nel nostro lab |
...
| [Alert Fatigue e Tuning](docs/alert-fatigue.md) | Strategie di tuning: livelli di severita', esclusioni syscheck, aggregazione con regole composite, esempi XML |
